...
alert("Let's have fun, my friends!!")
...
const jouerCase = (e) => {
  ...
  // récupérer  ID de la case clickée
  ...
  if (isVctoire === true) {
    ...
    resetState();
    cases.forEach((c) => (c.textContent = "")); //pour faire un clean de case
...
// un lister devras écouter toutes les ecases de Array et appeler le fonction JouerCase
cases.forEach((el) => {
